             ...
             <div class="single-post row">
              ...
              <div class="col-lg-3  col-md-3 meta-details">
               ...
               <div class="user-details row">
                  <p class="user-name col-lg-12 col-md-12 col-6"><a href="#">{{$post->trainer->name}}</a> <span class="lnr lnr-user"></span></p>
                  <p class="date col-lg-12 col-md-12 col-6">{{$post->created_at->format('d/m/Y')}}<span class="lnr lnr-calendar-full"></span></p>
